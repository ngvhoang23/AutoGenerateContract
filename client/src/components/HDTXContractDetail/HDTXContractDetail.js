...
import styles from "./HDTXContractDetail.module.scss";
import { useState } from "react";
import DetailItem from "../DetailItem/DetailItem";

const cx = classNames.bind(styles);

function HDTXContractDetail({ contractData, setContractData, onSubmit }) {
  return (
...
export default HDTXContractDetail;
