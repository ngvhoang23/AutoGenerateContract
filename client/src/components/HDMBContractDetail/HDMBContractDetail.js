...
import styles from "./HDMBContractDetail.module.scss";
...
function HDMBContractDetail({ contractData, setContractData, onSubmit }) {
  return (
    <div className={cx("wrapper")}>
      <div className={cx("container")}>
        ...
        <DetailItem
          className={cx("detail-item")}
          lable="Ve viec"
          value={contractData?.regarding}
          setValue={(value) =>
            setContractData((prev) => {
              return { ...prev, regarding: value };
            })
          }
        />
        <DetailItem
...
export default HDMBContractDetail;
