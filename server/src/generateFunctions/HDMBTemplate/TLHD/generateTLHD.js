...
const generateTLHD = async (sell_com, buy_com, contract_info, file_name) => {
    ...
    children: [
      new TextRun({
        children: [
          ...
          } với ${buy_com?.lower_case_name} V/v: ${contract_info?.regarding || "........"}`,
        ],
        italics: true,
        size: 24,
        break: 1,
  ...
  const rule1 = new Paragraph({
    ...
    children: [
      ...
      new TextRun({
        children: [new Tab(), `Bên A cung cấp hàng hóa theo yêu cầu cho bên B theo đúng yêu cầu.`],
        size: 24,
        break: 1,
      }),
      new TextRun({
  ...
  const para6 = new Paragraph({
    ...
    children: [
      ...
      new TextRun({
        children: [
          ` ký ngày ...... / ...... /${contract_info?.year} giữa ${sell_com?.lower_case_name} với ${
            buy_com?.lower_case_name
          } V/v: ${contract_info?.regarding || "........"}`,
        ],
        italics: true,
        size: 24,
      }),
