...
const generateDNTT = async (sell_com, buy_com, contract_info, invoice, file_name) => {
  ...
  const para1 = new Paragraph({
    ...
    children: [
      ...
      ...renderComNameOnly(buy_com?.name, 45),
    ],
  });
  ...
  const para2 = new Paragraph({
    ...
    children: [
      new TextRun({
        children: [
          new Tab(),
          `Căn cứ hợp đồng Số: ${contract_info?.code} ký ngày ${contract_info?.day || "......"} / ${
            contract_info?.month || "......"
          } / ${contract_info?.year || "......"} giữa ${sell_com?.lower_case_name} với ${
            buy_com?.lower_case_name
          } V/v: thuê xe vận chuyển.`,
        ],
        italics: true,
        size: 24,
      }),
  ...
  const para6 = new Paragraph({
    ...
    children: [
      ...
      new TextRun({
        children: [` ${buy_com?.lower_case_name} `],
        bold: true,
        italics: true,
        size: 24,
      }),
  ...
  const para7 = new Paragraph({
    ...
    children: [
      ...
      new TextRun({
        children: [` ${invoice?.total_after_tax?.toLocaleString() || invoice?.total_after_tax} `],
        bold: true,
        size: 24,
      }),
      new TextRun({
  ...
  const totalPriceByWords = new Paragraph({
    ...
    children: [
      new TextRun({
        children: [`Bằng chữ: ${invoice?.total_price_by_words}./.`],
        bold: true,
        italics: true,
        size: 24,
      }),
