...
const generateDNTT = async (sell_com, buy_com, contract_info, invoices, file_name) => {
  ...
  const para2 = new Paragraph({
    ...
    children: [
      new TextRun({
        children: [new Tab(), `- Căn cứ hợp đồng Số:`],
        italics: true,
        size: 24,
      }),
      new TextRun({
        children: [` ${contract_info?.code} `],
        italics: true,
        bold: true,
        size: 24,
      }),
      new TextRun({
        children: [
          `ký ngày ${contract_info?.day || "......"} / ${contract_info?.month || "......"} / ${
            contract_info?.year || "......"
          } giữa ${sell_com?.lower_case_name} với ${
            buy_com?.lower_case_name
          } V/v: thuê khoán nhân công`,
        ],
        italics: true,
        size: 24,
      }),
  ...
  const para3 = new Paragraph({
    ...
    children: [
      new TextRun({
        children: [`- Căn cứ hóa đơn GTGT số: 00000561 ngày 26 tháng 02 năm 2024`],
        italics: true,
        size: 24,
      }),
    ],
  ...
  const para4 = new Paragraph({
    ...
    children: [
      new TextRun({
        children: [`- Căn cứ hóa đơn GTGT số: 00000548 ngày 24 tháng 02 năm 2024`],
        italics: true,
        size: 24,
      }),
    ],
  ...
  const createSellComInfo = () => {
    return new Paragraph({
      ...
      children: [
        ...renderComName(sell_com?.name, 48, 4, false),
